...
/**
 * @ORM\Entity(repositoryClass="App\Entity\Repository\OptionValueDescriptionRepository")
...
class OptionValueDescription
{
    ...
    /**
     * @ORM\Id
     * @ORM\ManyToOne(targetEntity="App\Entity\OptionValue", inversedBy="descriptions")
     * @ORM\JoinColumn(name="option_value_id", referencedColumnName="option_value_id")
     */
    private OptionValue $optionValue;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Option", inversedBy="optionValueDescriptions")
